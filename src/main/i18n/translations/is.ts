...
const translationsIs: Translations  = {
	...
	"import-instructions-day-one": "Opnaðu Day One forritið og fluttu út dagbókina þúna undir File → Export → Plain Text. Afþjappaðu skrána sem varð til. Veldu TXT skrána í næsta skrefi til að færa hana inn í {appName}.",
