...
const translationsEs: Translations = {
	...
	"import-instructions-mini-diary": "Puedes importar los datos de una exportación previa desde {appName} en formato JSON o desde otro fichero JSON que tenga el formato adecuado.",
