...
const translationsZhTw: Translations = {
	...
	"import-instructions-jrnl": "要輸出 jrnl 檔案，請執行命令 {command}. 然後將輸出的 JSON 檔案輸入 {appName} 。",
	"import-instructions-mini-diary": "你可以將之前由 {appName} 輸出的 JSON 檔案或者其它相同格式的 JSON 檔案輸入。",
	"start-import": "開始輸入",
