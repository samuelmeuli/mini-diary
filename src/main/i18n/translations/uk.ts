...
const translationsUk: Translations = {
	...
	"reset-diary-msg": "Ви впевнені, що хочете скинути (видалити) ваш щоденник?\nБуде видалено всі ваші записи. Дані неможливо буде відновити (якщо немає резервної копії)",
	...
	"import-instructions-jrnl": "Щоб експортувати ваш щоденник jrnl, виконайте цю команду: {command}.\nВ наступному кроці, виберіть створений JSON файл, щоб імпортувати його в {appName}.",
