...
const translationsZhTW: Translations = {
	...
	"import-instructions-day-one": "打開 Day One ，依次點擊 File → Export → {format}，輸出檔案並且解壓縮，然後將解壓縮後的文件輸入{appName}。",
	"import-instructions-jrnl": "要輸出 jrnl 檔案，請執行命令 {command}. 然後將輸出的JSON檔案輸入{appName}。",
	"import-instructions-mini-diary": "你可以從之前由{appName}輸出的JSON文件或者其它相同格式的JSON文件輸入。",
	"start-import": "開始輸入",
