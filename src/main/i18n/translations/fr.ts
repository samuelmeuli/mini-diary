...
const translationsFr: Translations = {
	...
	"import-instructions-day-one": "Ouvrez l'application Day One et exportez votre journal depuis le menu Fichier → Exporter → Plain Text. Ouvrez le fichier au format ZIP. Sélectionnez le fichier TXT demandé lors de l'importation via {appName}.",
